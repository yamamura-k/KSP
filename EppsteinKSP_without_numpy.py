...
class EppsteinKSP:
    ...
    def computeH_out(self, node, G, nodeHeaps: Dict[int, "EppsteinHeap"], weight="weight") -> None:
        ...
        if bestSidetrack:
            bestSidetrackHeap = EppsteinHeap(bestSidetrack, sidetrackCost=G[bestSidetrack.fromNode][bestSidetrack.toNode]["delta"])
    ...
    def addHeapEdgeChildrenToQueue(self, kpathImplicit: "EppsteinPath", ksp: List[NamedTuple], pathPQ: List["EppsteinPath"]) -> None:
        """
    ...
    def addCrossEdgeChildToQueue(self, outrootHeaps: Dict[int, "EppsteinHeap"], kpathImplicit: "EppsteinPath", prefPath: int, ksp: List[NamedTuple], pathPQ: List["EppsteinPath"]) -> None:
        """
    ...
    def computeH_T_recursive(self, node, currentArrayHeap: "EppsteinArrayHeap", nodeHeaps: Dict[int, "EppsteinHeap"], outroorHeaps: Dict[int, "EppsteinHeap"], reversedSPT: DiGraph) -> None:
        """
...
class EppsteinHeap:
    def __init__(self, sidetrack: tuple = None, sidetrackCost: float = 0.0, children: List["EppsteinHeap"] = None, numOtherSidetracks: int = 0) -> None:
